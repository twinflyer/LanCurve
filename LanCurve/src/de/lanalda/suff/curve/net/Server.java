...
import de.lanalda.suff.curve.common.Position;
...
public class Server{
	...
	public void setPositionOf(String in)
	{
		...
		Position pos = new Position(Integer.getInteger(array[1]), Integer.getInteger(array[2]));
	...
	{
		ident ++;
		playerRegistry.register(new Player(new Position((int) Math.random()*100, (int) Math.random()*100), String.valueOf(ident)));
